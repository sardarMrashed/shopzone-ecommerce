    ...
    <div className='min-h-screen flex' style={{ background: '#0a0a0a' }}>
      ...
      <div className='w-full lg:w-1/2 flex items-center justify-center p-8' style={{ background: '#0a0a0a' }}>
        <div className='w-full max-w-md'>
          <h2 className='text-4xl font-bold mb-2' style={{ color: '#D4AF37' }}>Welcome Back</h2>
          <p className='mb-8' style={{ color: '#888' }}>Login to your exclusive account</p>
          ...
          <p className='text-center mt-6' style={{ color: '#888' }}>
            ...
            <Link to='/register' className='font-bold hover:underline' style={{ color: '#D4AF37' }}>
              Register here
            </Link>
          </p>
        </div>
